...
<div class="section">
  <div class="container">
    <div class="row center">
      <form action="altaJuego2.php" method="post" enctype='multipart/form-data'>  
        <div class="col m6 s12" id="preview">
        </div>
        <div class="input-field col s12 m6">
          <input type="text" name="nombre" id="usuario" placeholder="nombre" required>
          <textarea name="descripcion" placeholder="descripcion" required> </textarea>
          <input type="number" name="anio" placeholder="año lanzamiento">
