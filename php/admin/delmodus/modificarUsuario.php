...
<div class="section">
	<div class="container">
		<div class="row center">
			<form action="modificarUsuario2.php" method="post" enctype='multipart/form-data'>
				<div class="col m6 s12" id="preview">
					<img src="../../../common/foto/usuarios/<?php echo $u['foto'] ?>" class="fotoAdmin">
				</div>
				<div class="input-field col m6 s12">
					<input type="text" name="nnombre" size="50" value="<?php echo $u['nombre']; ?>">	
					<input type="text" name="npass" size="20" value="<?php echo $u['pass']; ?>">
