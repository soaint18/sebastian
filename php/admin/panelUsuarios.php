...
<?php
    ...
    if(isset($_SESSION['u_usuario'])){
    	$registro = $conexion->query("SELECT * FROM usuarios")
...
<?php
    while ($f = $registro->fetch_array()) {
    	echo '<tr>';
     	echo '<td>'.$f['nombre'].'</td>';      
    	echo '<td>'.$f['pass'].'</td>';      
    	echo '<td><img src="../../common/foto/usuarios/'.$f['foto'].'" class="fotoAdmin"></a></td>';
    	echo '<td><a href="delmodus/borrarUsuario.php?id='.$f['id'].'"><i class="small material-icons red-text">delete</i></a></td>';      
    	echo '<td><a href="delmodus/modificarUsuario.php?id='.$f['id'].'"><i class="small material-icons ligthblue-text">border_color</i></a></td>'; 
    	echo '</tr>'; 
    }
?>
			<tr><td colspan="5"><a href="delmodus/altaUsuario.php"><i class="medium material-icons green-text">person_add</i>
</a></td>
			</tr>
</table>
<?php 
